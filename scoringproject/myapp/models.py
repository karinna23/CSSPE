...
class CustomUser(AbstractUser):
    ...
    password = models.CharField(max_length=255)  # This field will store hashed passwords
    ...
    def save(self, *args, **kwargs):
        ...
        if self.pk is None:  # Only hash when creating the user
...
class LabananMatch(models.Model):
    ...
    user = models.ForeignKey(CustomUser, on_delete=models.CASCADE)  # Store user reference

    def __str__(self):
        return f"Match {self.matchID} - {self.event} by {self.user.username}"
...
class FormMatch(models.Model):
    ...
    def __str__(self):
        return f"Form {self.formID} - {self.form_type} by {self.user.username}"
...
class FormPlayers(models.Model):
    ...
    time = models.CharField(max_length=255, default=0, null=True, blank=True)
    lost_control = models.IntegerField(default=0, null=True, blank=True)
    outside = models.CharField(max_length=255, default=0, null=True, blank=True)
...
class VolleyballMatch(models.Model):
    ...
    home_team = models.ForeignKey(VolleyballTeam, related_name='home_team', on_delete=models.CASCADE, blank=True, null=True)
    away_team = models.ForeignKey(VolleyballTeam, related_name='away_team', on_delete=models.CASCADE, blank=True, null=True)
    home_team_timeout = models.CharField(max_length=100, blank=True)
    away_team_timeout = models.CharField(max_length=100, blank=True)
    ...
    def __str__(self):
        return f"Match {self.matchID} - {self.match_no} by {self.user.username}"
...
class VolleyballScore(models.Model):
    ...
    team = models.ForeignKey(VolleyballTeam, related_name='team', on_delete=models.CASCADE, blank=True, null=True)
...
class SingleTennisMatch(models.Model):
    ...
    player1_name = models.ForeignKey(TennisPlayers, related_name='player1', on_delete=models.CASCADE, blank=True, null=True)
    player2_name =models.ForeignKey(TennisPlayers, related_name='player2', on_delete=models.CASCADE, blank=True, null=True)
...
class SingleTennisScore(models.Model):
    ...
    player = models.ForeignKey(TennisPlayers, related_name='player', on_delete=models.CASCADE, blank=True, null=True)
    score = models.IntegerField(blank=True, null=True)
...
class DoubleTennisMatch(models.Model):
    ...
    time = models.CharField(max_length=100, blank=True, null=True)
    stage = models.CharField(max_length=100, blank=True, null=True)
    player1_name = models.ForeignKey(TennisPlayers, related_name='double_player1', on_delete=models.CASCADE, blank=True, null=True)
    player2_name =models.ForeignKey(TennisPlayers, related_name='double_player2', on_delete=models.CASCADE, blank=True, null=True)
    player3_name = models.ForeignKey(TennisPlayers, related_name='double_player3', on_delete=models.CASCADE, blank=True, null=True)
    player4_name =models.ForeignKey(TennisPlayers, related_name='double_player4', on_delete=models.CASCADE, blank=True, null=True)
    player1_timeout = models.IntegerField(blank=True, null=True)
    player2_timeout = models.IntegerField(blank=True, null=True)
    winning_team = models.CharField(max_length=100, blank=True)
    losing_team = models.CharField(max_length=100, blank=True)
...
class DoubleTennisScore(models.Model):
    ...
    player = models.ForeignKey(TennisPlayers, related_name='double_player', on_delete=models.CASCADE, blank=True, null=True)
    score = models.IntegerField(blank=True, null=True)

    def __str__(self):
        return f"{self.player} - {self.score} in {self.setID}"

# class SportUser(AbstractUser):
#     SPORT_CHOICES = [
#         ('arnis', 'Arnis'),
#         ('volleyball', 'Volleyball'),
#         ('table_tennis', 'Table Tennis'),
